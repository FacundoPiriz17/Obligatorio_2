...
public class PlanificadorPrioridades extends Planificador {
    ...
    @Override
    public List<String> ejecutar() { // ejecuta el planificador por prioridades
    ...
    public int verificarLlegada(List<Proceso> listaEspera, PriorityQueue<Proceso> cola, int indice, int tiempoActual) { // verifica
                                                                                                                        // en
                                                                                                                        // qué
                                                                                                                        // tiempo
                                                                                                                        // llega
    ...
    public int ejecutarProceso(Proceso actual, int tiempoActual, Collection mapeoFinal) { // ejecuta el proceso actual
        mostrarEncabezadoTiempo(tiempoActual);
